 ...
 *   2. Already on the student's bookshelf (bought, gifted, or free-added)
 *   3. Active subscription's gift list includes this book
 *   4. Otherwise: purchasable, gated on wallet balance
 */
class BookAccessService
{
    public function hasAccess(?Student $student, Book $book): bool
    {
        return in_array($this->accessType($student, $book), ['free', 'owned', 'subscription_gift'], true);
    }
