...
<body style="font-family: sans-serif; color: #1a1a2e; max-width: 500px; margin: 0 auto;">
    ...
    <p>Hi {{ $order->student->name }}, your order has been confirmed.</p>
    <table style="width: 100%; border-collapse: collapse; margin: 16px 0;">
        <tr><td style="padding: 6px 0; color: #6b6b8a;">Order #</td><td style="padding: 6px 0;">{{ $order->order_number }}</td></tr>
        <tr><td style="padding: 6px 0; color: #6b6b8a;">Type</td><td style="padding: 6px 0; text-transform: capitalize;">{{ str_replace('_', ' ', $order->orderable_type) }}</td></tr>
        <tr><td style="padding: 6px 0; color: #6b6b8a;">Amount</td><td style="padding: 6px 0;">৳{{ $order->amount }}</td></tr>
        <tr><td style="padding: 6px 0; color: #6b6b8a;">Payment Method</td><td style="padding: 6px 0; text-transform: capitalize;">{{ $order->payment_method }}</td></tr>
    </table>
